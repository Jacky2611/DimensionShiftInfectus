...
public class ChunkProviderInfectus implements IChunkProvider {
	/**
	 * RNG.
	 */
	private Random rand;
	...
	public ChunkProviderInfectus(World par1World, long par2, boolean par4) {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		 ...
		 * 
		 * if (biomegenbase != BiomeGenBase.desert =BIOMEDSWOODS && !flag &&
		 * this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider,
		 * worldObj, rand, par2, par3, flag, LAKE)) { k1 = k +
		 * this.rand.nextInt(16) + 8; l1 = this.rand.nextInt(256); i2 = l +
		 * this.rand.nextInt(16) + 8; (new
		 * WorldGenLakes(Blocks.water)).generate(this.worldObj, this.rand, k1,
		 * l1, i2); }
		 */
